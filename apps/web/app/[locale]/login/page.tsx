  ...
  return (
    <PageTransition>
      <main className="relative flex min-h-screen overflow-hidden">
        ...
        <motion.div
          className="absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-primary-500/20 blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.2, 0.3, 0.2],
          }}
        ...
        <div className="relative hidden w-1/2 flex-col justify-center p-16 lg:flex">
          <div className="relative z-10">
            ...
            {/* Feature highlights */}
            <StaggerChildren staggerDelay={0.1} className="mt-12 grid grid-cols-2 gap-6">
              ...
              <Form form={form} layout="vertical" onFinish={handleSubmit} size="large">
                ...
                <Form.Item className="mb-6">
                  <Button
                    ...
                    htmlType="submit"
                    block
                    isLoading={loading || loginMutation.isPending}
